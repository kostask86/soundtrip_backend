...
class Song(Base):
    ...
    mb_recording_mbid: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    mb_release_mbid: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    mb_release_group_mbid: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    ...
    lyrics_language: Mapped[str | None] = mapped_column(String(80), nullable=True)
